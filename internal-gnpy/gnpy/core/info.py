...
class Channel(namedtuple('Channel', 'channel_number channel_index frequency baud_rate slot_width roll_off power chromatic_dispersion pmd pdl')):
    """ Class containing the parameters of a WDM signal.
        :param channel_number: channel number in the WDM grid
        :param channel_index: channel index in the WDM grid
...
class SpectralInformation(object):
    ...
    def __init__(self, frequency: array, baud_rate: array, slot_width: array, signal: array, nli: array, ase: array,
        ...
        self._channel_index = asarray(self._channel_number) - 1
    ...
    @property
    def carriers(self):
        entries = zip(self.channel_number, self.channel_index, self.frequency, self.baud_rate, self.slot_width,
